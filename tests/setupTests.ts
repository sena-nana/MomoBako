    ...
    if (command === "get_api_design_snapshot") {
      return {
        ...
        endpoints: [
          ...
          {
            group: "Plugin API / Office Convert",
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.office-convert:officeConvert.ensurePreviewPdf",
            summary: "确保 Office 文档存在可复用的 PDF 预览缓存。",
          ...
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.office-convert:officeConvert.getRuntimeStatus",
            summary: "读取 Office 转换服务运行状态。",
            pluginId: "momobako.service.office-convert",
          ...
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.office-convert:officeConvert.clearPreviewCache",
            summary: "清理当前资源库下的 Office PDF 预览缓存。",
            pluginId: "momobako.service.office-convert",
          ...
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.office-convert:officeConvert.runRuntimeSelfCheck",
            summary: "执行一次真实 Office 转换运行时自检。",
            pluginId: "momobako.service.office-convert",
          ...
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.office-convert:officeConvert.shutdownDaemon",
            summary: "关闭当前 LibreOffice 守护进程。",
            pluginId: "momobako.service.office-convert",
            pluginMethod: "officeConvert.shutdownDaemon",
            requestTemplate: {},
          },
          {
            group: "Plugin API / Downloader",
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.downloader:downloader.getRuntimeStatus",
            summary: "读取 aria2 下载运行时状态。",
          ...
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.downloader:downloader.ensureRuntime",
            summary: "确保 aria2 下载运行时可用。",
            pluginId: "momobako.service.downloader",
          ...
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.downloader:downloader.enqueueDownload",
            summary: "创建或恢复一个通用下载任务。",
            pluginId: "momobako.service.downloader",
            pluginMethod: "downloader.enqueueDownload",
            requestTemplate: {
              url: "https://example.invalid/archive.zip",
              destinationPath: "./tmp/momobako-downloader-test.zip",
              metadata: {
                kind: "api-test",
              },
            },
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.downloader:downloader.awaitDownload",
            summary: "等待一个通用下载任务完成。",
            pluginId: "momobako.service.downloader",
          ...
          },
          {
            ...
            transport: "plugin-call",
            method: "PLUGIN",
            path: "momobako.service.downloader:downloader.removeDownload",
            summary: "移除一个通用下载任务。",
            pluginId: "momobako.service.downloader",
          ...
          },
          {
            ...
            transport: "tauri-command",
            method: "INVOKE",
            path: "prepare_repository_cache_file_preview_source",
            command: "prepare_repository_cache_file_preview_source",
            summary: "将资源库缓存目录内文件注册为受控预览源。",
            requestTemplate: {
              request: {
                repoId: "repo-main-001",
