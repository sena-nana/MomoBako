...
impl RepositoryState {
    ...
    pub fn create_repository(
        ...
        repository_management::create_repository(self, request)
    }
    ...
    pub fn import_repository(
        ...
        repository_management::import_repository(self, request)
    }
    ...
    pub fn attach_repository_folder(
        ...
        repository_management::attach_repository_folder(self, request)
    }

    pub fn delete_repository(&self, repo_id: &str) -> Result<(), String> {
        repository_management::delete_repository(self, repo_id)
    }
    ...
    pub fn relocate_repository(
        ...
        repository_management::relocate_repository(self, request)
    }
    ...
    pub fn update_repository_backend_config(
        ...
        repository_management::update_repository_backend_config(self, request)
    }
    ...
    pub fn configure_netease_repository_cache(
        ...
        repository_management::configure_netease_repository_cache(self, request)
    }
    ...
    pub fn export_repository(
        ...
        repository_management::export_repository(self, request)
    }
    ...
    pub fn add_playlist_items_by_paths(
        ...
        asset_ids.sort();
        asset_ids.dedup();
        self.add_playlist_items(PlaylistItemsAddRequest {
    ...
    pub fn sync_repository(&self, request: SyncRequest) -> Result<SyncResult, String> {
        repository_management::sync_repository(self, request)
    }
    ...
    fn sync_repository_with_candidate_skips(
        ...
        repository_management::sync_repository_with_candidate_skips(
            self,
            repo_id,
...
mod tests {
    ...
    fn prepare_entry_playback_source_delegates_virtual_tracks_to_downloader() {
        ...
        let connection = state
            ...
            .expect("repository connection should open");
        let asset_id = asset_id_for_path(&repo_id, "Created/demo-track.mp3");
        connection
            .execute(
                r#"
                INSERT INTO assets (
        ...
        connection
            .execute(
                ...
                VALUES (?1, 'songId', 'number', '1001', 1, ?2)
                "#,
                params![asset_id, "2026-06-14T00:00:00Z"],
            )
            .expect("song metadata should be inserted");
        drop(connection);
    ...
    fn prepare_entry_playback_source_prefers_repository_backend_cookie_over_stale_asset_payload() {
        ...
        let connection = state
            ...
            .expect("repository connection should open");
        let asset_id = asset_id_for_path(&repo_id, "Created/stale-track.mp3");
        connection
            .execute(
                r#"
                INSERT INTO assets (
